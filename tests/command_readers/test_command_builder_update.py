...
def case_command_builder_update_with_nothing():
    version = "1.3.4"
...
@case(tags=SUCCESSFUL_TAG)
def case_command_builder_update_version():
...
@case(tags=SUCCESSFUL_TAG)
def case_command_builder_update_override_default_args():
    command_builder = CommandBuilder(
...
@case(tags=SUCCESSFUL_TAG)
def case_command_builder_update_from_config_add_default_args():
    command_builder = CommandBuilder(
        name=COMMAND1, help=COMMAND_HELP_STRING1, default_args=[ARG1, ARG2]
    )
...
@case(tags=SUCCESSFUL_TAG)
def case_command_builder_update_clear_default_args():
    command_builder = CommandBuilder(
        name=COMMAND1, help=COMMAND_HELP_STRING1, default_args=[ARG1, ARG2]
    )
...
@case(tags=SUCCESSFUL_TAG)
def case_command_builder_update_from_config_add_required_contexts():
    command_builder = CommandBuilder(
...
@case(tags=SUCCESSFUL_TAG)
def case_command_builder_update_from_config_add_allowed_contexts():
    command_builder = CommandBuilder(
...
@case(tags=SUCCESSFUL_TAG)
def case_command_builder_update_from_config_add_context_specification():
    command_builder = CommandBuilder(
        name=COMMAND1,
        help=COMMAND_HELP_STRING1,
        contexts_specifications={CONTEXT1: ContextSpecification(clear_args=True)},
...
def case_command_builder_update_fail_on_both_clear_args_and_args():
    command_builder = CommandBuilder(
        name=COMMAND1,
        help=COMMAND_HELP_STRING1,
        contexts_specifications={CONTEXT1: ContextSpecification(clear_args=True)},
...
@case(tags=[FAILED_TAG])
def case_command_builder_update_fail_on_both_clear_args_and_add_args():
    command_builder = CommandBuilder(
        name=COMMAND1,
        help=COMMAND_HELP_STRING1,
        contexts_specifications={CONTEXT1: ContextSpecification(clear_args=True)},
...
@case(tags=[FAILED_TAG])
def case_command_builder_update_fail_on_both_args_and_add_args():
    command_builder = CommandBuilder(
        name=COMMAND1,
        help=COMMAND_HELP_STRING1,
        contexts_specifications={CONTEXT1: ContextSpecification(clear_args=True)},
