...
def test_build_commands_from_empty_list(clear_configuration):
...
def test_build_commands_with_one_command_builder_passing_filter(clear_configuration):
...
def test_build_commands_with_few_passing_command_builders(clear_configuration):
